...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3264912;
      var PACKAGE_UUID = 'd90f1a2a-3d21-4ef8-9dfb-7981665d027c';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20496, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20496, 31648, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31648, 171168, 0, 0).open('GET', '/level0');
    new DataRequest(171168, 171189, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(171189, 171435, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(171435, 206407, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(206407, 1679187, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1679187, 3176559, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3176559, 3237287, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(3237287, 3264912, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
